...
.data
    ...
    open_error           db  "Nie mo�na otworzy� pliku",0
    size_error           db  "Nieprawid�owy rozmiar pliku",0
    mem_error            db  "Za ma�o pami�ci",0
...
start:
    ...
    ;___________________________________ G��WNA PROCEDURA ____________________________________
    ...
    ;_______________________________ OBS�UGA ZDARZE� _______________________________
